Public Class Level5
    ...
    Private Sub Level5_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Level5_Load(sender As Object, e As EventArgs) Handles Me.Load
        Randomize()
        Timer1.Enabled = True
        MakePipes(1)
        MakeTopPipes(1)
            ...
            If bird.Enabled = True Then
                ...
                If score = pipesToCross Then
                    ...
                    If score > Startscr.Label2.Text Then
                        Startscr.Label2.Text = score
                    End If
                    Startscr.Label7.Text = 5
                    MsgBox("Congratulations! You Won!", MsgBoxStyle.OkOnly, "Flappy Bird")
                    Me.Close()
                End If
            End If
